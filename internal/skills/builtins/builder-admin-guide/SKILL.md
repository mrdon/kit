...
description: "How to build tenant-scoped apps with Kit's builder: meta-tool workflow, service-layer pattern, field-type conventions, validation, concurrency gotchas, LLM budget awareness, error handling, and a full meta + built-in reference. Use whenever an admin asks to build, modify, debug, schedule, or expose a script-backed app via create_app / create_script / expose_script_function_as_tool."
admin_only: true
---

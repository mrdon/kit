...
// with three bullets, a band with one long one, a band with no door time, and
// a day carrying a second event as a bullet.
func sampleTopper() Topper {
	return Topper{
		...
		Rows: []TopperRow{
			...
			{Day: "SAT", Time: "2pm", Title: "Re-Launch Party", Bullets: []string{"Join Don and Matt as we celebrate the next orbit of Gravity Brewing", "Special beer release and discounts", "Also: Bike Night · 6pm"}},
		},
	}
}

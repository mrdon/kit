...
var eventsTools = []services.ToolMeta{
	{
		...
		Schema: services.PropsReq(map[string]any{
			...
			"featured":    services.Field("boolean", "Lead with this event on the website. When several are featured, the soonest wins."),
	...
	},
	{
		...
		Schema: services.PropsReq(map[string]any{
			...
			"featured":            services.Field("boolean", "Lead with this event on the website."),

...
type DecisionData struct {
	...
	ResolvedJobID       *uuid.UUID       `json:"resolved_job_id,omitempty"`
	// OriginJobID and OriginSessionID, when both non-nil, wire the
...
type DecisionCreateInput struct {
	...
	// OriginJobID + OriginSessionID, when both non-nil, stamp the

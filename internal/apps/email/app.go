...
- search_emails supports Gmail query syntax on Gmail accounts (` + "`has:attachment`, `from:`, `newer_than:7d`" + ` etc.); otherwise a small subset of ` + "`from:` `to:` `subject:` `since:YYYY-MM-DD` `is:unread`" + ` parses into IMAP criteria.
